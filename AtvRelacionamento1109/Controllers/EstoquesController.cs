...
namespace AtvRelacionamento1109.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class EstoquesController : ControllerBase
    {
        private readonly AtvRelacionamento1109Context _context;

        public EstoquesController(AtvRelacionamento1109Context context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Estoque>> PostEstoque(Estoque estoque)
        {
          if (_context.Estoque == null)
          {
              return Problem("Entity set 'AtvRelacionamento1109Context.Estoque'  is null.");
          }
